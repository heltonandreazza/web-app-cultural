  ...
  <div className='min-h-screen pt-16 pb-12 flex flex-col bg-white'>
    <main className='flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8'>
      ...
      <div className='py-16'>
        <div className='text-center'>
          ...
          <p className='mt-2 text-base text-gray-500'>Desculpe, não conseguimos encontrar a página que você está procurando.</p>
          <div className='mt-6'>
    ...
    <footer className='flex-shrink-0 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8'>
      <nav className='flex justify-center space-x-4'>
        <a href={getWhatsUrl(CTA_WA_MESSAGES.pageNotFound)} className='text-sm font-medium text-gray-500 hover:text-gray-600'>
          Contato
        </a>
