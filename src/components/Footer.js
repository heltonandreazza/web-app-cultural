    ...
    <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8'>
      <div className='xl:grid xl:grid-cols-3 xl:gap-8'>
        <div className='space-y-8 xl:col-span-1'>
          <img className='h-14' src={src} alt='Academia cultural' />
          <p className='text-gray-500 text-base'>Fazendo do mundo um lugar melhor e mais saudável para se viver.</p>
        ...
        <div className='mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2'>
          <div className='md:grid md:grid-cols-2 md:gap-8'>
            ...
            <div className='mt-12 md:mt-0'>
              <h3 className='text-sm font-semibold text-gray-400 tracking-wider uppercase'>Informações</h3>
              <ul className='mt-4 space-y-4'>
                <li>
                  <a
                ...
                <li>
                  <a href={URLS.appstore} target='_blank' className='text-base text-gray-500 hover:text-gray-900' rel='noreferrer'>
                    App apple store
                  </a>
                </li>

                <li>
                  <a href={URLS.playstore} target='_blank' className='text-base text-gray-500 hover:text-gray-900' rel='noreferrer'>
                    App play store
                  </a>
                </li>
              </ul>
          ...
          <div className='md:grid md:grid-cols-2 md:gap-8'>
            ...
            <div className='mt-12 md:mt-0'>
              ...
              <ul className='mt-4 space-y-4'>
                <li>
                  <a href='/politicas-de-privacidade' className='text-base text-gray-500 hover:text-gray-900' target='_blank'>
      ...
      <div className='mt-12 border-t border-gray-200 pt-8'>
        <p className='text-base text-gray-400 xl:text-center'>&copy; 2021 Academia Cultural, todos os direitos reservados.</p>
      </div>
    </div>
  </footer>
)
