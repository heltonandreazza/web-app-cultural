    ...
    <div className='lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start'>
      <div className='relative sm:py-16 lg:py-0'>
        ...
        <div className='relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20'>
          ...
          <div className='relative rounded-2xl shadow-xl overflow-hidden'>
            <GatsbyImage className='absolute inset-0 h-full w-full object-cover' image={author.image.localFile?.childImageSharp?.gatsbyImageData} />
            ...
            <div className='absolute bottom-0 left-0 px-8 py-4'>
              <blockquote className='mt-8'>
                ...
                <footer className='mt-4'>
                  <p className='text-base font-semibold text-green-200'>{`${author.name}, ${author.role} na Academia Cultural`}</p>
                </footer>
              </blockquote>
            </div>
          </div>
      ...
      <div className='relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0'>
        ...
        <div className='pt-12 sm:pt-16 lg:pt-20'>
          ...
          <div className='mt-6 text-gray-500 space-y-6 text-lg' dangerouslySetInnerHTML={{ __html: author.bio.childMarkdownRemark.html }} />
        </div>
        {/* Stats section */}
        <div className='mt-8'>
          <dl className='grid grid-cols-2 gap-x-4 gap-y-8'>
            <div key='Desde' className='border-t-2 border-gray-100 pt-6'>
              ...
              <dd className='text-3xl font-extrabold tracking-tight text-gray-900'>{author.createdAt?.split('-')[0]}</dd>
            </div>
            <div key='Postagens' className='border-t-2 border-gray-100 pt-6'>
              <dt className='text-base font-medium text-gray-500'>Postagens</dt>
              <dd className='text-3xl font-extrabold tracking-tight text-gray-900'>{author.post?.length}</dd>
            </div>
          </dl>
          <div className='mt-10'>
