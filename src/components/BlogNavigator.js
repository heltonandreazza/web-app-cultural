...
const Navigator = ({ showMenuMobile, onClickOpenMenuMobile, onClickCloseMenuMobile }) => (
  <div className='container mx-auto h-24 flex items-center justify-between 2xl:px-32'>
    ...
    <nav className='hidden sm:flex items-center justify-between'>
      ...
      <a className='px-4 text-green-600 hover:text-green-800' href='https://academia-cultural.kpages.online/resultadoja'>
        Cursos
      </a>
      ...
      <a className='px-4' href='#'>
        <button
          ...
          onClick={() => window.open('https://play.google.com/store/apps/details?id=com.academiacultural.culturalapp')}
        >
          Sou um aluno
        </button>
      </a>
    ...
    <div className={`${showMenuMobile ? '' : 'hidden'} absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden z-10`}>
      <div className='rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden'>
        ...
        <div className='px-2 pt-2 pb-3'>
          ...
          <a href='/authors' className='block px-3 py-2 rounded-md text-base font-medium text-green-600 hover:text-green-800 hover:bg-green-50'>
            Equipe
          </a>
        </div>
        <a
