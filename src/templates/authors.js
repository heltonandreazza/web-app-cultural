...
const Authors = ({
  ...
  return (
    <div className='bg-white'>
      <Seo title='Blog Academia Cultural Equipe' type='blog' url={location?.href} />
      <Navigator
        ...
        <div className='space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0'>
          <div className='space-y-5 sm:space-y-4'>
            ...
            <p className='text-xl text-gray-500'>
              A Academia Cultural é uma academia especializada em desenvolvimento de projetos de vida para a sua saúde.
            </p>
            <p className='text-xl text-gray-500'>Aqui nós temos profissionais dedicados e apaixonados pelo que fazemos.</p>
            <p className='text-xl text-gray-500'>
              Somos agentes da transformação diária de toda essa nova era da saúde e ajudamos pessoas a colocarem em prática seus projetos de vida.
                    ...
                    <div className='sm:col-span-2'>
                      <div className='space-y-4'>
                        ...
                        <ul className='flex space-x-5'>
                          <li>
                            <a href={person.urlInstagram} className='text-green-400 hover:text-green-500'>
